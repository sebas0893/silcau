<%@ Page Title="Informe mensual" MasterPageFile="~/Paginas/Admin.Master" Language="C#" AutoEventWireup="true" CodeBehind="AdminNuevoInforme.aspx.cs" Inherits="Vista.Paginas.AdminNuevoInforme" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <!-- Modal popup Agregar -->
    <asp:ModalPopupExtender ID="mpeAgregar" runat="server" TargetControlID="hlIngreso" CancelControlID="btCerrarAgregar" BackgroundCssClass="modalBackground" PopupControlID="pnlAgregar" DropShadow="true">
    ...
    <asp:Panel ID="pnlAgregar" runat="server" Style="display: none; left: 0px; background: white;" Width="500px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <label>Municipio &nbsp;<asp:RequiredFieldValidator ID="rfvMunicipio" runat="server" ControlToValidate="ddlMunicipio" ErrorMesesage="*" Font-Size="20px" ForeColor="red" ValidationGroup="mes" ErrorMessage="*"></asp:RequiredFieldValidator></label>
                <asp:DropDownList ID="ddlMunicipio" runat="server" class="form-control" DataTextField="nombre" DataValueField="codigo">
                </asp:DropDownList>
                ...
                <asp:FilteredTextBoxExtender ID="tbAnio_fte" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="tbAnio">
                ...
                <label>¿Fueron otorgadas licencias ó autorizaciones en el mes a reportar? &nbsp;<asp:RequiredFieldValidator ID="rfvOtorgadas" runat="server" ControlToValidate="ddlOtorgadas" ErrorMesesage="*" Font-Size="20px" ForeColor="red" ValidationGroup="mes" ErrorMessage="*"></asp:RequiredFieldValidator></label>
                <asp:DropDownList runat="server" ID="ddlOtorgadas" class="form-control" ValidationGroup="mes">
                    <asp:ListItem Value="">Seleccione</asp:ListItem>
    ...
    <asp:ModalPopupExtender ID="mpeEliminar" runat="server" Enabled="false" TargetControlID="gvMeses" BackgroundCssClass="modalBackground" PopupControlID="pnlEliminar" DropShadow="true">
    </asp:ModalPopupExtender>
    <!-- Panel Eliminar -->
            ...
            <div class="container-fluid well">
                <div class="row-fluid">
                    <div class="span4" style="width: 300px">
                        ¿Desea eliminar este Informe mensual?</div>
                </div>
            </div>
        </div>
        <div class="modal-footer">
