    ...
    public partial class InformeMensual : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (codigoRol != "2") Server.Transfer("Bienvenido.aspx");
        ...
        protected void btConfirmar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Redireccionar a Informes
                string codigoRol = (string)Session["rol"];
                if (codigoRol.Equals("1")) Server.Transfer("AdminInforme.aspx");
                else Server.Transfer("Informes.aspx");
            }
            catch (Exception exc)
            {
        ...
        protected void gvReporte_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                rfvAnexo.Enabled = fuAnexo.Enabled = false;
        ...
        private DetalleReporteDTO getDetalleReporte()
        {
            ...
            detalleReporteDTO.Anexo = detalleReporteDTO.Resolucion + " " + detalleReporteDTO.Fecha + ".pdf";
        ...
        private void limpiarDetalleReporte()
        {
            ...
            rfvAnexo.Enabled = fuAnexo.Enabled = true;
