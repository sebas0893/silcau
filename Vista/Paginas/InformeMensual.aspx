<%@ Page Language="C#" Title="Informe mensual" MasterPageFile="~/Paginas/Admin.Master" AutoEventWireup="true" CodeBehind="InformeMensual.aspx.cs" Inherits="Vista.Paginas.InformeMensual" %>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <asp:HyperLink runat="server" ID="hlCerrar" class="btn btn-primary" role="button" NavigateUrl="~/Paginas/Informes.aspx">Cerrar</asp:HyperLink>
    ...
    <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="panel-body">
                    ...
                    <div style="background-color: #9e9e9e1f" class="alert alert-success alert-sm">
                ...
                <label>PDF de la licencia, concepto y/o autorización otorgada (Máximo 2 Mb) &nbsp;<asp:RequiredFieldValidator ID="rfvAnexo" runat="server" ControlToValidate="fuAnexo" ErrorMessage="*" Font-Size="20px" ForeColor="red" ValidationGroup="reporte"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="revAnexo" runat="server" ControlToValidate="fuAnexo" ErrorMessage="Anexar PDF" ForeColor="red" ValidationExpression="^.*\.(pdf|PDF)$" ValidationGroup="reporte"></asp:RegularExpressionValidator>
                </label>
